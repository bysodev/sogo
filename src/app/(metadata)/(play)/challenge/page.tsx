...
export default function ChallengePage() {
  ...
  // <main className="relative place-items-center">
  //   <div>
  //     <div className="absolute h-96 w-80 rounded-2xl bg-gray-400"></div>

  //     <div className="absolute h-96 w-80 hover:mt-6 space-y-6 rounded bg-white transition-all duration-700 ease-out">
