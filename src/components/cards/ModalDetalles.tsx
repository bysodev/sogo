        ...
        >
            ...
            <DialogContent>
                ...
                <div className="flex justify-around my-2 gap-2">
                    <div className="w-2/3 bg-slate-100 rounded-2xl p-4 flex flex-col justify-center gap-2 hover:mb-4 transition-all duration-700 ease-out">
                    ...
                    <div className="w-1/3 bg-sky-100 rounded-2xl p-4 flex flex-col justify-center gap-2 hover:mt-4 transition-all duration-700 ease-out">
...
const palabras = {
    ...
    contentCategory: "Los desafíos estarán centrados en las vocales, palabras y objetos, los cuales se utilizarán para llevar a cabo diversas actividades, tal como se ejemplifica a continuación.",
    itemsCategory: ['Deletreo', 'Autocompletado', 'Selección', 'Un intento']
}

const numeros = {
    title: 'Retos con Numeros',
    contentCategory: "En esta cateogria encontrara retos que le lleven a penzar el resultado de una operación matematica basica y poder hacer en señas el resultado, puede ser por deletreo o en algunos casos solo de una unica imagen deducir los numeros o el resultado por escrito",
