            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-lg 2xl:text-xl text-gray-500 dark:text-gray-300 mb-4">Plataforma desarrollada por estudiantes del departamento de Ciencias de la Computación de la Universidad de las Fuerzas Armadas ESPE sede Santo Domingo. Cursando el último semestre de la carrera de Tecnologías de la Información</p>
                  <ul className="text-base 2xl:text-lg text-gray-500 dark:text-gray-300 -mb-2">
                    <li className="flex items-center mb-2">
                      <div className="font-architects-daughter relative before:top-1/2 before:bottom-1/2 before:-translate-y-1/2 before:content-[''] before:w-2 before:h-2 before:absolute before:bg-purple-500"><span className='ms-6 font-extrabold'>Directora: <span className='font-medium'>Martínez Verónica</span></span></div>
                    </li>
                    <li className="flex items-center mb-2">
                      <div className="font-architects-daughter relative before:top-1/2 before:bottom-1/2 before:-translate-y-1/2 before:content-[''] before:w-2 before:h-2 before:absolute before:bg-purple-500"><span className='ms-6 font-extrabold'>Tesistas:</span><ul className='absolute ms-[6.7rem] top-0 font-medium whitespace-nowrap'><li>Solórzano Bryan</li><li>Goyes Anthony</li></ul></div>
                    </li>
                  </ul>
                </div>
              </div>
