          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={"/images/feature-default.jpg"} width={540} height={405} alt="Features 01" />
              </div>
              {/* Content */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-gray-500 dark:text-gray-300 mb-4">SoGo Sign nace de la necesidad de una plataforma completamente gratuita para <span className='bg-purple-500 text-white px-2 hover:bg-purple-600 transition duration-300'>aprender lengua de señas ecuatoriana (LSE)</span> de manera dinámica, divertida y efectiva.</p>
                  <p className="text-xl text-gray-500 dark:text-gray-300 mb-4">Plataforma desarrollada por estudiantes del departamento de Ciencias de la Computación de la Universidad de las Fuerzas Armadas. Cursando su último semestre de la carrera de Ingeniería en Sistemas de la Información y Telecomunicaciones</p>
                  <ul className="text-lg text-gray-500 dark:text-gray-300 -mb-2">
                    <li className="flex items-center mb-2">
                      <div className="font-architects-daughter relative before:top-1/2 before:bottom-1/2 before:-translate-y-1/2 before:content-[''] before:w-2 before:h-2 before:absolute before:bg-purple-500"><span className='ms-6 font-extrabold'>Verónica Martínez</span></div>
                    </li>
                    <li className="flex items-center mb-2">
                      <div className="font-architects-daughter relative before:top-1/2 before:bottom-1/2 before:-translate-y-1/2 before:content-[''] before:w-2 before:h-2 before:absolute before:bg-purple-500"><span className='ms-6 font-extrabold'>Solórzano Bryan</span></div>
                    </li>
                    <li className="flex items-center">
                      <div className="font-architects-daughter relative before:top-1/2 before:bottom-1/2 before:-translate-y-1/2 before:content-[''] before:w-2 before:h-2 before:absolute before:bg-purple-500"><span className='ms-6 font-extrabold'>Goyes Anthony</span></div>
                    </li>
                  </ul>
                </div>
              </div>
