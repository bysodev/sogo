            ...
            <div className="h-fit md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-lg 2xl:text-xl text-gray-500 dark:text-gray-300 mb-4 text-justify">Prototipo inicial de una Plataforma multipropósito desarrollada por estudiantes del departamento de Ciencias de la Computación de la Universidad de las Fuerzas Armadas ESPE sede Santo Domingo. Cursando el último semestre de la carrera de Tecnologías de la Información</p>
