        ...
        <div className="py-12 md:py-20">
          ...
          <div className="grid gap-20">
            ...
            <div className="h-fit md:grid md:grid-cols-12 md:gap-6 items-center">
              {/* Image */}
              <div className="h-[27rem] relative max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                <Image className="w-full max-w-auto h-full object-contain transition-opacity duration-500 hover:opacity-0" src={"/images/foto-grupal-1.webp"} width={300} height={200} alt="Features 01" />
                <Image
                  className="h-[27rem] absolute inset-0 w-full object-contain opacity-0 transition-opacity duration-500 hover:opacity-100"
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-lg 2xl:text-xl text-gray-500 dark:text-gray-300 mb-4 text-justify">Prototipo inicial desarrollada por estudiantes del departamento de Ciencias de la Computación de la Universidad de las Fuerzas Armadas ESPE sede Santo Domingo. Cursando el último semestre de la carrera de Tecnologías de la Información</p>
